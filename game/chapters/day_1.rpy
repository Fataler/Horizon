label day_1:
    ...
    play sfx sfx_strem_steps fadein 0.5 fadeout 1.0 loop
    ...
    R_t "Я нажал на кнопку входа в отсек."
    ...
    #цг Виктор у панели
    R_t "Виктор сидел, сжавшись, у панели калибровки двигателя."
    ...
    V "Ты!.."
    R_t "Виктор указал на меня окровавленным пальцем. Рука его дрожала, но во взгляде будто на секунду мелькнул проблеск разума."
    V "Всё началось с тебя!.."
    R_t "Я почти не слушал его. Напряжение нарастало, нужно было обдумать план действий."
