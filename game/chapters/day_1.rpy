label day_1:
    ...
    R_t serious think "Больше нельзя было мешкать — по протоколу рабочий день начинается строго в восемь утра."
    ...
    V pockets happy "Коллеги, я всё-таки смог словить пакет. Но, чёрт побери, это звучит… странно."
    ...
    show i smoke calm
    D calm "Может, отражение от ионосферы? Заметь, мы в апогее — угол наклона большой."
    ...
    R_t thinking ne_ponyal "Напротив, находиться здесь было приятно."
    R_t thinking osharashen "Вид, который открывался из нашего большого окна, был просто потрясающим."
    R_t "Мимо проносились огоньки сгорающих и снова зажигающихся звёзд, целые системы, пути."
    ...
    R_t suspicious "Конечно, было немного жаль, что не повезло с командой."
    ...
    R_t not_sure "Но что ни день — какое-то событие, не соскучишься."
    R_t ear neutral "Я откинулся на кресле и закинул руки за голову. Всего лишь месяц."
    R_t "Это совсем не срок для космической экспедиции."
    ...
    R_t surprised "Приключение туда-обратно не должно было доставить проблем."
    R_t thinking not_sure "Я прищурил глаза и всмотрелся в тёмную даль."

    #цг полёт анимация
    R_t thinking neutral "Полёт внутри корабля почти не ощущался."
    ...
    R_t "Я знал, каково это — через это проходят все, кто стремится стать членом экипажа."
    R_t suspicious "Искусственные условия для тренировки, когда твоё тело помещают в быстро раскручивающуюся вокруг своей оси гигантскую центрифугу..."
    R_t "...и ты крутишься, словно волчок, — захватывают дух."
    R_t not_sure "Но это никогда не сравнится с ощущением «плавания» в открытом космосе. По-настоящему."
    R_t "В скафандре и за пределами корабля."
    R_t ear neutral "Отчасти это можно назвать моей мечтой."
    R_t surprised "Все экспедиции, членом которых мне удалось побывать, проходили без инцидентов, потому для меня не было острой необходимости покидать корабль."

    #цг чинит корабль анимация 
    R_t thinking suspicious "По протоколу мы имеем право делать это лишь в исключительных случаях — для устранения поломки или определения неполадок."
    R_t ear sick "Более того, являясь навигатором, вряд ли мне когда-либо удастся осуществить это небольшое желание — в починке механических повреждений или устранении неполадок электроники я, увы, ничего не смыслю."
    R_t thinking not_sure "Но у меня всегда было ощущение, что рано или поздно я познаю эти ощущения."
    R_t neutral "Они были так знакомы где-то в глубине сознания, будто я уже много раз их испытывал."
    ...
    #цг игла в руке
    R_t ear sick "Я поднял руку к лицу и увидел, как кровь стекает по моей ладони."

    scene bg_black with dissolve

    R_t serious fainting "В глазах потемнело."
    ...
    R_t serious think "Софи и Ирис испуганно взглянули на меня."
    ...
    R_t ear neutral "Он придавал мне толику уверенности, поэтому я держал руку около него — будто просто решил опереться пальцем о карман."
    ...
    R_t thinking suspicious "Судя по широкой спине и уверенной походке, это был капитан."
    R_t thinking not_sure "Ирис убеждала не посвящать капитана, пока мы не поговорим с Виктором и не поймём, кто устроил этот кошмар."
    R_t "И двигался он прямо в нашу сторону."
    R_t ear surprised "Мне необходимо было срочно принять решение."
    R_t "Неизвестно, свернёт ли он куда-либо до того, как увидит нас, или пойдёт прямо."
    R_t dissatisfied "Рисковать было нельзя: преждевременная встреча могла сорвать наш план."
    R_t "Я проскочил в первое попавшееся помещение: дверь была рядом."
    ...
    R_t "Врач и механик забежали следом."
    ...
    R_t serious think "И правда, если приглядеться, было заметно, что алая жидкость медленно льётся из ушей радиста."
