label day_1:
    ...
    R_t serious neutral "Больше нельзя было мешкать — по протоколу рабочий день начинается строго в восемь утра."
    R_t serious neutral "Быстро натянув костюм, я отметился в терминале и направился в кухонный модуль."

    play sfx sfx_steps fadein 0.5 fadeout 0.5 loop
    scene black with dissolve
    pause 0.5
    scene bg_dinner_block
    show i pen ozadachen right at Transform(xalign=0.8, yalign=1.0)
    show s ruki ozadachen right at quad_left_center
    show v profile smile left at Transform(xalign=1.2, yalign=1.0)
    ...
    V ruki tricky "Коллеги, я всё-таки смог словить пакет. Но, чёрт побери, это звучит… странно."
    ...
    play sfx sfx_steps 
    show v left at move_on_scene(xalign=-1.0)
    pause 1.0
    stop sfx fadeout 0.5
    ...
    R_t serious think "Оперевшись рукой на подлокотник, чтобы дотянуться до небольшого отсека с личными вещами, я почувствовал резкую боль в руке."

    #цг игла в руке
    R_t thinking osharashen "Я поднял руку к лицу и увидел, как кровь стекает по моей ладони."
    ...
    R_t thinking ne_ponyal "Не теряя самообладания, я взглянул на подлокотник и увидел еле заметную, но довольно крупную иглу."
    ...
    R_t ear neutral "Я вытащил несколько игл в качестве образца (благо их было достаточно много, чтобы оставить часть на месте для демонстрации)."
    ...
    R_t ear neutral "Я аккуратно раздвинул края рваной ткани и, зацепив двумя пальцами, вытащил то, что находилось под обшивкой."
