label day_1:
    ...
    R_t "После лет, проведённых в плену осознанных сновидений и сонных параличей, я уже утратил способность удивляться подобным выходкам сознания."
    ...
    cutscene "Я расслабленно опёрся на спинку кресла и убрал руки за голову. Всего лишь месяц."
    ...
    cutscene "…и ты вертишься, словно волчок, — захватывают дух."
    ...
    #цг 5 начало
    $ show_scene_cosmos("5")
    cutscene "По протоколу мы имеем право делать это лишь в исключительных случаях — для определения неполадок или устранения поломки."
    ...
    R_t serious angry "Брак обшивки кресла? Бред. Я уже тысячу раз облокачивался на него."
    ...
    cutscene "Я вытащил несколько игл в качестве образца."
    cutscene "Благо их было достаточно, чтобы оставить часть на месте для демонстрации."
    ...
    S "Кто-то вставил иглу мне в ботинок, когда я отошла в душевую."
    ...
    I bychit "Вы не поверите, но речь о капитане."
    R thinking osharashen "Как такое вообще может быть?"
    I profile neutral "В первую очередь необходимо пообщаться с Виктором."
    I "Нам нужно заручиться поддержкой ещё одного члена экипажа, прежде чем вести переговоры с бывшим любителем мистики."
    ...
    R suspicious "Всё это было странно с самого начала."
    ...
    cutscene "Странного и неприятного вида тотемы, собранные из множества частей."
    ...
    R serious think "Всё отменяется. Мы должны поговорить с Дэвидом."
