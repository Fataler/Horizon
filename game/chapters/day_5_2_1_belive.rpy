label day_5_2_1_belive:
    ...
    E "Да… Это были долгие месяцы осознания, что никто не знает, что с тобой и где ты…"
    E "Когда мы смогли понять, что ваш корабль попал в аномалию и подключиться к камерам, я снова обрела надежду!"
    ...
    R_t thinking ne_ponyal "Ещё некоторое время она давала мне указания, я записывал код, который должен был заменить в программе двигателя."
    ...
    R_t thinking ne_ponyal "Корабль весь трясло, но я был уверен — всё идёт так, как должно быть."
    R_t "Она так сказала."
