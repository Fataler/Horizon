label day_5:
    ...
    R_t surprised "В солидном возрасте с ним случилось то, чего мы все так боимся."
    R_t "Разум начал ослабевать, деменция взяла своё."
    R_t thinking ne_ponyal "Трудно спорить с человеком, не контролирующим ход своих мыслей и не обладающим критическим мышлением."
    R_t "Итак. Как мне помогла эта информация?"
    R_t not_sure "Думаю, вряд ли в этом есть хоть какой-то смысл."
