label day_5:
    ...
    R_t "В периоды обострения своего недуга он начинал видеть в каждом человече своего врага."
    R_t "Подозревал нас во всех смертных грехах."
    #цг НЕТ КОНЕЦ
    #цг 14 начало
    R_t "Одним из его любимых занятий было найти особенный повод для того, чтобы лишить нас того, что мы любим."
