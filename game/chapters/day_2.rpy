label day_2:
    ...
    R_t "До школы оставалось немного времени — я садился на влажную после ночного ливня скамейку на выходе из дома."
    ...
    R "Я не склонен обвинять людей, но она выглядит совершенно растерянной."
    ...
    cutscene "Так же, как и я, он нуждался в наставнике — крепком мужском плече, которое вовремя направит на путь истинный."
    ...
    cutscene "Однажды, подглядев за ним в щель двери его комнаты, я увидел, что тело брата покрыто ранами и ссадинами."
