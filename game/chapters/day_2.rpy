label day_2:
    ...
    V "Он разряжен, и я не могу заряжать от резервного источника энергии второстепенные устройства."
    ...
    R_t "Так же, как и я, он нуждался в наставнике — крепком мужском плече, которое вовремя наставит на путь истинный."
