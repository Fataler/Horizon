label day_4:
    ...
    R_t ear dissatisfied "Вызвать её приступ ярости не составляло труда. Страшнее всего было по вечерам, когда она приходила с работы и выпивала."
...
# R Надеюсь, это не пригодится.
    ...
    show v scared right with dissolve
