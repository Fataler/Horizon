label day_0_prologue:
    ...
    R_t serious think "Ужин начал остывать."
    I normal angry "Это уже надоедает."
    R_t ear hehe "Я усмехнулся."
    R ear hehe "Следующая очередь — твоя, не так ли?"
    V "С каких пор нам приходится определять очередь для того, чтобы пощёлкать выключателем?"
    ...
    R ear hehe "В чём сложность подняться и сходить прогуляться в генераторную?"
    R "Разминка очень полезна для мышц и суставов."
    R "Приступим к ужину или будем продолжать попытки переложить ответственность друг на друга?"
    ...
    R_t serious think "Никто не хотел отвечать, но все обратили внимание на оратора."
    D fist annoyed "Как вы уже знаете, третий день мы находимся без связи."
    D fist confused "Виктор пытается соединиться с командным центром на протяжении всего этого времени, но безуспешно."
    ...
    D fist annoyed "Поэтому приказ на сегодня такой: умерить свою гордыню. А также пересмотреть своё отношение к остальным членам экипажа."
    D confused "Это относится ко всем, кто по какой-то причине не уверен в коллегах."
    ...
    R_t "Члены экипажа неспешно прибрали за собой столы и начали расходиться по своим каютам."
    ...
    R_t thinking not_sure "Экспедиция не задалась с самого начала."
    R_t "Надежды на дружную команду не оправдались, но это было не так важно."
    ...
    R_t thinking neutral "Книги для меня — как будто своеобразные галлюцинации, которые ты можешь генерировать в своём мозгу при чтении."
    R_t "Даже среди ледяной пустоты космоса разум способен унести тебя в любую точку вселенной."
    ...
    R_t "Да, сказать честно, никто из нас не смог попасть в ту команду, членом экипажа которой хотел бы быть."
    R_t hehe "Волею случая нас распределили в команду «Сборная солянка из того, что осталось»."
