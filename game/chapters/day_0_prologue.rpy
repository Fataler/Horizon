label day_0_prologue:
    ...
    D happy "Рано унывать — мы всё ещё имеем планы на миссию и возможность их осуществить."
    ...
    play sfx kitchen_table fadein 0.5 fadeout 1.0
    ...
    R_t hehe "Волею случая мы были определены в «Сборную солянку из отбросов»."
