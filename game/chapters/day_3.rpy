label day_3:
    ...
    #music тревога
    play music music_reflections fadein 0.5 loop
    ...
    R_t neutral "Припоминая тёплый приём в лазарете, мне не хотелось лишний раз её видеть."
    ...
    R_t "Я не сразу смог разглядеть, но Ирис лежала на полу."
    R_t "Рука её была прикована наручниками к ножке кровати."
    ...
    S shy worried "Внешне с тобой всё хорошо."
    ...
    #music
    stop music fadeout 1.0
    play music2 music_escape_room_full fadein 1.0 loop
    menu:
        "Попытаться взломать сейф":
            R_t "Я понял, что медлить нельзя."
            ...
            R_t "Ну же, Райан… Вспоминай…"
            R_t "Что это может быть?"
            R_t "Всего 4 цифры…"
            R_t "Вот они, даже кнопки продавлены…"
            $ result = renpy.call_screen("password_keypad", expected_code=1734)
