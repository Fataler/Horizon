...
# R_t serious angry "Внутри не было никаких лекарств… Только фото. Это было фото… Моего близкого человека."
# R_t serious angry "Как оно оказалось здесь. В сейфе Ирис?.."
