...
label scene_hand_needle:
    ...
    cutscene "Подняв руку к лицу, я увидел в ней торчащую иглу, а по ладони стекала кровь."
    cutscene "В глазах потемнело."
    cutscene "Не теряя самообладания, я взглянул на подлокотник и увидел там ряд еле заметных небольших игл."
