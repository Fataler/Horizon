...
label scene_good_ending:
    ...
    cutscene "Но мне повезло намного больше, чем остальному — реальному — экипажу нашей миссии."
    cutscene "Они умерли мгновенно при столкновении с аномалией."
    cutscene "Как позже выяснили ученые, импульс аномалии вызывает катастрофическую перегрузку нейронов в бодрствующей коре мозга."
    cutscene "Я выжил лишь потому, что проспал момент столкновения, был без сознания."
    ...
    cutscene "Как в голове заменил их на личины своих близких."
    ...
    cutscene "Шум моря. Волна за волной накатывали воспоминания о моём родном доме, словно оживляя картинки в памяти."
    cutscene "Я распалил масляную лампу своей зажигалкой и раскрыл рюкзак."
