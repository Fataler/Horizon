...
image cosmos_fon_1 = At("images/CG/CG_fon_cosmos/fon/potato/CG_fon_cosmos_potato_0000s_0000_4.png", fade_in_out(delay=1))
image cosmos_fon_2 = At("images/CG/CG_fon_cosmos/fon/potato/CG_fon_cosmos_potato_0000s_0001_3.png", fade_in_out(delay=2))
image cosmos_fon_3 = At("images/CG/CG_fon_cosmos/fon/potato/CG_fon_cosmos_potato_0000s_0002_2.png", fade_in_out(delay=3))
...
label show_cosmos_background(image_number, frame_count=2):
    show screen cosmos_background_screen(image_name=image_number, frame_count=frame_count)
